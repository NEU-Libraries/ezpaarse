...
ezLanguages['en'] = {
  ...
  "form+design_format":     "Design my log format",
  ...
  "form+autodetect_success":  "The automatic detection determined the format of your log lines",
  "form+autodetect_fail":     "The automatic detection failed to determine the format of your log lines",
  "form+format":              "Format",
  "form+regular_expression":  "Regular expression",
  "form+partial_format":      "Partial format",
  "form+full_format":         "Full format",
  "form+regexp_failed":       "The regular expression could not be built from the format",
  ...
  "settings+custom_settings":      "Custom settings",
  "settings+loading_predefined":   "Loading predefined settings",
  "settings+loading_personal":     "Loading personal settings",
  "settings+error":                "An error occured, please try again",
  "settings+modified":             "modified",
  "settings+predefined_choice":    "Choose a predefined set of parameters...",
  "settings+personal_choice":      "Choose a personal set of parameters...",
  "settings+no_result_for":        "No result for",
  "settings+save":                 "save",
  "settings+delete":               "delete",
  "settings+save_current_as":      "Save current settings as",
  ...
  "admin+resources_are_uptodate":     "Resources are up-to-date",
  ...
  "admin+resources_description":      "Predefined settings and other resources that don't depend on ezPAARSE version.",
